  ...
  if (item.isSuccess === false) {
    return (
      <div className="flex justify-between items-center bg-slate-100 rounded-md px-[10px] py-[18px] dark:bg-slate-600">
        ...
        <button onClick={clickToSuccess} className="flex justify-center items-center cursor-pointer">
        <i className="ri-checkbox-blank-circle-line ri-xl"></i>
        </button>
        ...
        <button onClick={clickToDelete} className="flex justify-center items-center text-red-600 cursor-pointer">
